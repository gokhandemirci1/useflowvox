            ...
            {!logoError && (
              <div className="flex justify-center mb-8">
                <div className="relative group cursor-pointer">
                  {/* Subtle glow effect */}
                  <div className="absolute -inset-2 md:-inset-3 lg:-inset-4 bg-gradient-to-r from-purple-600/20 via-pink-600/20 to-cyan-600/20 rounded-full blur-xl md:blur-2xl opacity-50 group-hover:opacity-75 transition-opacity duration-500"></div>
                  
                  {/* Orbiting particles container */}
                  <div className="absolute inset-0 w-full h-full flex items-center justify-center pointer-events-none">
                    {/* Outer orbit - Particles */}
                    <div className="absolute w-32 h-32 md:w-40 md:h-40 lg:w-48 lg:h-48" style={{ animation: 'orbit 20s linear infinite' }}>
                      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-2.5 h-2.5 md:w-3 md:h-3 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 shadow-lg shadow-purple-500/80"></div>
                      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-2 h-2 md:w-2.5 md:h-2.5 rounded-full bg-gradient-to-r from-pink-500 to-purple-500 shadow-lg shadow-pink-500/80"></div>
                      <div className="absolute left-0 top-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-gradient-to-r from-purple-400 to-pink-400 shadow-lg shadow-purple-400/70"></div>
                      <div className="absolute right-0 top-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-gradient-to-r from-pink-400 to-purple-400 shadow-lg shadow-pink-400/70"></div>
                    </div>
                    
                    {/* Middle orbit - Particles (reverse) */}
                    <div className="absolute w-24 h-24 md:w-32 md:h-32 lg:w-40 lg:h-40" style={{ animation: 'orbit 15s linear infinite reverse' }}>
                      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-2 h-2 md:w-2.5 md:h-2.5 rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 shadow-lg shadow-cyan-500/80"></div>
                      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-2 h-2 rounded-full bg-gradient-to-r from-blue-500 to-cyan-500 shadow-lg shadow-blue-500/80"></div>
                    </div>
                    
                    {/* Inner orbit - Small particles */}
                    <div className="absolute w-20 h-20 md:w-26 md:h-26 lg:w-32 lg:h-32" style={{ animation: 'orbit 25s linear infinite' }}>
                      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1.5 h-1.5 md:w-2 md:h-2 rounded-full bg-gradient-to-r from-purple-300 to-pink-300 shadow-lg shadow-purple-300/60"></div>
                      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-1.5 h-1.5 md:w-2 md:h-2 rounded-full bg-gradient-to-r from-pink-300 to-cyan-300 shadow-lg shadow-pink-300/60"></div>
                    </div>
                  </div>
                  
                  {/* Orbiting trace lines - SVG */}
                  <svg className="absolute pointer-events-none w-40 h-40 md:w-48 md:h-48 lg:w-56 lg:h-56" viewBox="0 0 200 200" style={{ left: '50%', top: '50%', transform: 'translate(-50%, -50%)' }}>
                    <defs>
                  ...
                  <div className="relative transform transition-all duration-700 ease-out group-hover:scale-105 group-hover:-translate-y-2 animate-float">
                    ...
                    <div className="relative backdrop-blur-md bg-gradient-to-br from-white/10 via-white/5 to-transparent rounded-full p-2 md:p-4 lg:p-5 border border-white/20 group-hover:border-white/40 shadow-2xl shadow-purple-500/20 group-hover:shadow-purple-500/40 transition-all duration-500">
                      {/* Inner glow */}
                      ...
                      <div className="relative z-10">
                        <img 
                          ...
                          alt="FlowVox AI Logo" 
                          className="h-16 w-16 md:h-24 md:w-24 lg:h-32 lg:w-32 rounded-full object-cover transition-all duration-700 group-hover:brightness-110 group-hover:contrast-110 ring-2 ring-white/10 group-hover:ring-white/30"
                          style={{
